...
async def test_get_product_info(httpx_mock):
    ...
    with open("test/test_cerulean_cloud/fixtures/productInfo.json") as src:
        ...
        httpx_mock.add_response(
            method="GET",
            url="https://roda.sentinel-hub.com/sentinel-s1-l1c/GRD/2020/7/29/IW/DV/S1A_IW_GRDH_1SDV_20200729T034859_20200729T034924_033664_03E6D3_93EF/productInfo.json",
            json=info,
        )
