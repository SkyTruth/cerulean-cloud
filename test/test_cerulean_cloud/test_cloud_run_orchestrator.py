...
def test_classify_geometry_background_mask_detects_sea_ice_aoi_when_land_clear():
...
def test_classify_geometry_background_mask_ignores_empty_sea_ice_matches():
    buffered_geometry = box(0, 0, 1, 1)
    land_mask_gdf = gpd.GeoDataFrame(geometry=[box(10, 10, 11, 11)], crs="EPSG:4326")
