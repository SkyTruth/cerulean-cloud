...
cloud_run_offset_tile_image_url = registry_url.apply(
    lambda url: f"{url}/{construct_name('cloud-run-offset-tile-image')}:{dir_hash('../', 'offset')}"
)
cloud_run_orchestrator_image_url = registry_url.apply(
    lambda url: f"{url}/{construct_name('cloud-run-orchestrator-image')}:{dir_hash('../', 'orchestrator')}"
)
cloud_run_tifeatures_image_url = registry_url.apply(
    lambda url: f"{url}/{construct_name('cloud-run-tifeatures-image')}:{dir_hash('../', 'tifeatures')}"
)
