...
instance = gcp.sql.DatabaseInstance(
    ...
    settings=gcp.sql.DatabaseInstanceSettingsArgs(
        ...
        database_flags=[
            ...
            gcp.sql.DatabaseInstanceSettingsDatabaseFlagArgs(
                name="shared_buffers", value=pulumi.Config("db").require("db-mem")
            ),
            ...
            gcp.sql.DatabaseInstanceSettingsDatabaseFlagArgs(
                name="temp_buffers", value="65536"
            ),
            # Max number of concurrent i/o processes
            # gcp.sql.DatabaseInstanceSettingsDatabaseFlagArgs(name="effective_io_concurrency", value="100"),
